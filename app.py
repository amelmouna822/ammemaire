...
@app.route("/choisir_specialite_demandeur")
def choisir_specialite_demandeur():
    return render_template("choisir_specialite_demandeur.html")


@app.route("/choisir_specialite_entreprise")
def choisir_specialite_entreprise():
    return render_template("choisir_specialite_entreprise.html")
